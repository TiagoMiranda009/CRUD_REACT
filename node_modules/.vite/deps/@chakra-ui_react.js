...
function createMotionComponent(_a) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return React9.createElement(
      ...
      features,
      React9.createElement(MotionContext.Provider, { value: context }, useRender(Component, props, projectionId, useMotionRef(visualState, context.visualElement, externalRef), visualState, config2.isStatic, context.visualElement))
    );
  }
...
var PresenceChild = function(_a) {
  ...
  var id2 = useId2();
  var context = (0, import_react34.useMemo)(
    function() {
      return {
        id: id2,
        initial: initial3,
...
function ReorderGroup(_a, externalRef) {
  ...
  return React16.createElement(
    ...
    React16.createElement(ReorderContext.Provider, { value: context }, children)
  );
}
...
var RemoveScroll = React48.forwardRef(function(props, parentRef) {
  ...
  return React48.createElement(
    React48.Fragment,
    null,
    enabled && React48.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref }),
    forwardProps ? React48.cloneElement(React48.Children.only(children), __assign3(__assign3({}, containerProps), { ref: containerRef })) : React48.createElement(Container5, __assign3({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
function RemoveScrollSideCar(props) {
  ...
  return React51.createElement(
    React51.Fragment,
    null,
    inert ? React51.createElement(Style2, { styles: generateStyle(id2) }) : null,
    removeScrollBar ? React51.createElement(RemoveScrollBar, { gapMode: "margin" }) : null
  );
}
